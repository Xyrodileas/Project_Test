...
public class OrdiUnitTest {
    ...
    @Test
    public void positionsLibresToolTest() throws PionMemePlaceException{
        ...
        Assert.assertTrue((OrdiTool.positionsLibres(gr1)).get(0).equals(pos1));
    }
    ...
    @Test
    public void getPositionToPlayTest() throws PionMemePlaceException {
        ...
        pos1 = new Position(3,3);
        Ordi ord1 = new Ordi("Maijin", gr1);

        Assert.assertTrue(pos1.equals(ord1.getPositionToPlay(p16)));

    }

    @Test
    public void declareQuarto() throws PionMemePlaceException {
        Piece p1 = new Piece(Couleur.CLAIRE, Forme.CARREE, Taille.HAUTE, Coeur.PLEINE);
        Piece p2 = new Piece(Couleur.CLAIRE, Forme.CARREE, Taille.HAUTE, Coeur.CREUSE);
        Piece p3 = new Piece(Couleur.CLAIRE, Forme.CARREE, Taille.BASSE, Coeur.PLEINE);
        Piece p4 = new Piece(Couleur.CLAIRE, Forme.CARREE, Taille.BASSE, Coeur.CREUSE);
        ...
        gr1.ajoutPion(pos1, p15);
        pos1 = new Position(3,3);
        gr1.ajoutPion(pos1, p16);

        Ordi ord1 = new Ordi("Maijin", gr1);
        Assert.assertTrue(ord1.declareQuarto());
    }
    ...
    public void winTest(){
        ...
        Ordi ord1 = new Ordi("NomTest", grid1);
        ord1.win();
        Assert.assertEquals("QUARTO\r\n", outContent.toString());
    }
